...
### 1. Set Up the Environment
   ...
   - **Goal**: Create a structured workspace within jupyter notebook for smooth analysis and data handling.
...
|-- jupyter.ipynb             # Main script for loading, cleaning, and processing data
```
---
